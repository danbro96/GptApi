...
/// <summary>
/// Readiness check: pings the llama-server worker. Reuses <see cref="LlamaClient.IsHealthyAsync"/>,
/// which applies its own 3s budget and swallows transport errors to a bool.
/// </summary>
internal sealed class WorkerHealthCheck(LlamaClient client) : IHealthCheck
{
